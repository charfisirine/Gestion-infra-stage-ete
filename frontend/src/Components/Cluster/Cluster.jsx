...
const Cluster = () => {
  ...
  const handleChangeEdit = (e) => {
    setClusterToEdit({ ...clusterToEdit, [e.target.id]: e.target.value });
  };
  ...
  const columns = [
    ...
    { field: "designation", headerName: "Cluster Name", width: 150 },
                ...
                <CardContent>
                  <form onSubmit={handleEditCluster}>
                    <TextField
                      label="Cluster Name"
                      id="designation"
                      value={clusterToEdit?.designation}
                    ...
                    <TextField
                      label="Description"
                      id="description"
                      value={clusterToEdit?.description}
                      onChange={handleChangeEdit}
                      sx={{ m: 1, width: "35ch" }}
                    />
                    <TextField
